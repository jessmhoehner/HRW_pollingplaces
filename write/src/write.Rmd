...
#FIXME:try tabyl with demographics of interest on top and l/g/m groups on left
#FIXME:add PA data
...
### Arizona
#FIXME: put this in terms of demographics first and then location change status
...
```{r newlocs, echo=FALSE, message=FALSE}

# use this for graphs with geometry data filtered by zipcodes 
# https://juliasilge.com/blog/using-tidycensus/ 

# AZ 
# how many locations in 2020 were new compared to 2016?
#Maricopa
...
# 350/470 addresses in 2020 data not found in 2016 data
...
# 799/1919 polling places are new in 2020
